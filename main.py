...
animal = pygame.image.load('Image/animal.jpg').convert_alpha()
t_rect = animal.get_rect(centerx = WIDTH//2, bottom=HEIGHT-2)
...
apple_surface = [pygame.image.load('Image/'+data['path']).convert_alpha() for data in apples]
...
def createApple(group):
    ...
    return Apple(x, speed, apple_surface[indx], apples[indx]['score'], group)
